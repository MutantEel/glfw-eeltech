...
## eel tech
This is the version of glfw that eel tech depends on. nothing major has been changed from the offical github repo besides removing examples, test, cmake and then adding in platform specific project files.
